...
docker run -d  --name pipeline-runner   --user websurfinmurf  --env-file /home/websurfinmurf/projects/secrets/pipeline.env  -v /home/websurfinmurf/projects:/projects -v /var/run/docker.sock:/var/run/docker.sock   websurfinmurf/pipeline-runner:latest
