...
docker run -d   --name pipeline-runner   --env-file ~/pipeline.env  -v /home/websurfinmurf/projects:/pipeline-runner/repos -v /var/run/docker.sock:/var/run/docker.sock   websurfinmurf/pipeline-runner:latest
